...
def get_parameters():
    ...
    parser.add_argument('--g_num', type=int, default=2)
    ...
    parser.add_argument('--version', type=str, default='sagan_128_bice2')
    ...
    parser.add_argument('--dataset', type=str, default='bice', choices=['lsun', 'celeb', 'bice', 'lena'])
    ...
    parser.add_argument('--model_save_step', type=float, default=500)
